    ...
    const testimonials = [
        {
            ...
            quote: "The intuitive interface and real-time reporting have streamlined our processes, allowing us to focus more on delivering exceptional customer service. It's a game-changer for any restaurant!"
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Simon andrew",
            title: "Software engineer",
            quote: "The integration with our POS and inventory management has cut down on errors and saved us countless hours. Highly recommended for any busy restaurant looking to boost efficiency."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Micheal worin",
            title: "Product designer",
            quote: "The system was easy to implement, and the customer service team was incredibly responsive to our needs. It’s been a fantastic investment for managing our restaurant more effectively."
        },
    ]

    return (
        <section className="relative py-14" id="review">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    Customer reviews are invaluable
                     insights that shape our product development 
                     and enhance our service. They provide direct 
                     feedback, allowing us to continually refine 
                     and improve our offerings to better meet your needs.
                  </p>
                </div>
                <div className="mt-12">
